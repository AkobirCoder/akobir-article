...
const Main = () => {
    ...
    return (
        <div className='row g-0 d-flex align-items-start border rounded' style={{minHeight: '100%'}}>
            <div className='col-12 col-md-7 d-flex flex-column align-items-between p-3'>
